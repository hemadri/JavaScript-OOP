...
package com.visualcondition.twease {	
	...
	public class Extend {
		...
		public static function checkExtendedProp(prop:*):Boolean{
			for ( var i:Object in Twease.extendedprops ) if(Twease.extendedprops[i][0] == prop) return true;
			return false;
		};
		...
		public static function initExtendedMethods(nexfuncs:Array, cl:*):void{
			for ( var i:Object in nexfuncs ) Twease[nexfuncs[i]] = cl[nexfuncs[i]];
		};
		...
		public static function initExtendedProps(nexprops:Object):void{
			...
			for ( var i:Object in nexprops ){
				var pr:Array = nexprops[i];
				for ( var j:Object in pr ) Twease.extendedprops[pr[j]] = [pr[j], i];
			};
		};
