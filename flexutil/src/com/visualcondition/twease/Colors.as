...
package com.visualcondition.twease {
	import flash.geom.ColorTransform;
	 ...
	 public class Colors {
		...
		public static var cl:Class = com.visualcondition.twease.Colors;
		...
		public static function setup(prop:String, tweenobj:Object):void {
			...
			for ( var i:String in tweenobj ) if(Twease.compareInObject(i, Twease.baseprops)) temptween[i] = tweenobj[i];
