package com.flexutil.ui.managers
{
	
	
	import com.flexutil.effects.BackgroundFadePopupBlocker;
	...
	public class EPPopUpManager
	{
		...
		private static function removeSheet(window:IFlexDisplayObject):void{
			tweenPosition(window, -window.height, EPPopUpManager.remove);
		}
...
//				Group(bounds.parent).addElement(largeMask);
			return largeMask;
		}
